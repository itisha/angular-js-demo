...
(function() {
    ...
    var tableHelper = function () {
        ...
        return {
            ...
            templateUrl: 'scripts/directives/tableHelperWithController/tableHelperTemplate.html'
        };
    };

    angular.module('angularApp')
        .directive('tableHelperWithController', tableHelper);
